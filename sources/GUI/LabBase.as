...
// Proxies
	...
	public function getTankPuddle() {
		return _root.overlay.getTankPuddle();
	}
	public function getGlassPuddle() {
		return _root.overlay.getGlassPuddle();
	}
...
// Подготовка рабочей среды к этапу
	...
	public function showRunning() {
		if(Config.Trace) trace("Show running call.");
...
// Сообщения об окончании попыток	
	public function showAssemblingAttemptsOver() {
		Alert.show(Strings.AssemblingAttemptsOverMsg,  Strings.AssemblingAttemptsOverCpt, Alert.OK, null, function() { _root.lab.onAttemptsOver(); });
	}
	public function showInstrumentsAttemptsOver() {
		Alert.show(Strings.InstrumentsAttemptsOverMsg, Strings.InstrumentsAttemptsOverCpt, Alert.OK, null, function() { _root.lab.onAttemptsOver(); });
	}
	public function showTurningOnAttemptsOver() {
		Alert.show(Strings.TurningOnAttemptsOverMsg,   Strings.TurningOnAttemptsOverCpt, Alert.OK, null, function() { _root.lab.onAttemptsOver(); });
	}
...
// Вопрос об окончании и сообщение об окончании	
	...
	public function showFinishMessage() {
		Alert.show(Strings.EndMsg, Strings.EndCpt, Alert.OK, this, function() { _root.lab.onFinishMsgOk(); });
	}
...
// Complex event handlers
	...
	public function onFinishMsgOk() {
		if(!Config.Standalone) this.app.onEnd();
	}
	
	public function onAttemptsOver() {
		onFinishMsgOk();
	}
